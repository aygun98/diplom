      ...
      <div className='blog-xeberler'>
        <div className="blog-xeberler-left">
          <div className="blog-xeberler-left-cards">
           <Link to='sonyazi'> <div className='blog-xeberler-left-img blog-xeberler-left-img1'><span className='blog-xeberler-left-img-span'>Məsləhətlər və Hiylə</span></div></Link>
            ...
            <Link to='sonyazi'>Daha çox oxu <IoIosArrowRoundForward /></Link>
          </div>
          <div className="blog-xeberler-left-cards">
          <Link to='sonyazi'> <div className='blog-xeberler-left-img blog-xeberler-left-img2 '><span className='blog-xeberler-left-img-span'>Məsləhətlər və Hiylə</span></div></Link>
            <h1>Drenajın təmizlənməsinə ehtiyacınız olduğunu necə bilmək olar</h1>
            <span><span className='blog-xeberler-left-cards-span'><BsPerson className='blog-xeberler-left-icon' /> admin </span> <span className='blog-xeberler-left-cards-span'><BsCalendar className='blog-xeberler-left-icon' /> 8 dekabr 2022-ci il</span><span className='blog-xeberler-left-cards-span'><AiOutlineFolderOpen className='blog-xeberler-left-icon' />Məsləhətlər və Hiylə</span></span>
            <p>Ana səhifə <IoIosArrowForward /> Tək Yazı Drenaj Təmizlənməsinə Ehtiyac Olduğunuzu Necə Bilirsiniz. Drenaj Təmizləmə Lorem Ipsum Dolor.</p>
            <Link to='sonyazi'>Daha çox oxu <IoIosArrowRoundForward /></Link>
          ...
          <div className="blog-xeberler-left-cards">
          <Link to='sonyazi'> <div className='blog-xeberler-left-img blog-xeberler-left-img3'><span className='blog-xeberler-left-img-span'>Məsləhətlər və Hiylə</span></div></Link>
            <h1>Drenajın təmizlənməsinə ehtiyacınız olduğunu necə bilmək olar</h1>
            <span><span className='blog-xeberler-left-cards-span'><BsPerson className='blog-xeberler-left-icon' /> admin </span> <span className='blog-xeberler-left-cards-span'><BsCalendar className='blog-xeberler-left-icon' /> 8 dekabr 2022-ci il</span><span className='blog-xeberler-left-cards-span'><AiOutlineFolderOpen className='blog-xeberler-left-icon' />Məsləhətlər və Hiylə</span></span>
            <p>Ana səhifə <IoIosArrowForward /> Tək Yazı Drenaj Təmizlənməsinə Ehtiyac Olduğunuzu Necə Bilirsiniz. Drenaj Təmizləmə Lorem Ipsum Dolor.</p>
            <Link to='sonyazi'>Daha çox oxu <IoIosArrowRoundForward /></Link>
        ...
        <div className="blog-xeberler-right">
          ...
          <div className='blog-xeberler-right-cards'>
            ...
            <Link to='sonyazi'><div className="blog-xeberler-right-card-img blog-xeberler-left-img1"></div></Link>
            ...
            <div className='blog-xeberler-right-card'>
            <Link to='sonyazi'>   <div className="blog-xeberler-right-card-img blog-xeberler-left-img2"></div></Link>
              <div className="blog-xeberler-right-card-text">
            ...
            <div className='blog-xeberler-right-card'>
            <Link to='sonyazi'>  <div className="blog-xeberler-right-card-img blog-xeberler-left-img3"></div></Link>
              <div className="blog-xeberler-right-card-text">
