...
<RxCrossCircled className='moda-cross-icon' onClick={()=> closeModalIframe(false)}/>
          ...
          <iframe  width="760" height="515" src="https://www.youtube.com/embed/wUh5R9cmmAU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
          </div>
          </div>
  )
}
